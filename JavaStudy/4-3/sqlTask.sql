...
-- [SELECT TBL1.store_code FROM store_table TBL1, stock_table TBL2 
--		WHERE TBL1.store_code = TBL2.store_code AND TBL2.quantity > ANY (SELECT AVG(quantity) From stock_table WHERE store_code = 'EA01')]
...
--	VALUES('M001','マフラー','4500','2020-10-04')
--	;
...
--	USING stock_table
--	WHERE goods_table.goods_code = stock_table.goods_code
--	AND goods_table.goods_code = 'S987'

--	SELECT SQL文
--	SELECT * FROM goods_table JOIN stock_table
--		ON goods_table.goods_code = stock_table.goods_code
--			WHERE goods_table.goods_code = 'S987']
